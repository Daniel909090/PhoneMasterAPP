...
{         // FileHandler.cs class has some redundant methods used for the version without Database
          // All the commented methods were moved to DatabaseManager.cs for the version with Database
